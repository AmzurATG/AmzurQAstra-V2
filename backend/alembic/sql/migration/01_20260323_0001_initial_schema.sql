...
-- Date: 2026-03-23
-- All tables, enums, indexes, triggers
-- ============================================
...
-- ==========================================================
-- SEED ADMIN USER
-- Update the email/password below to match your .env values
-- ==========================================================
-- Default: admin@qastra.dev / admin123
-- Password hash below is for 'admin123' — regenerate if you change the password
INSERT INTO users (email, hashed_password, full_name, role, is_active, is_superuser)
VALUES (
    'admin@qastra.dev',
    '$2b$12$LJ3m4ys3wzlGeK4W8sDKxeVbE5DzEZGNq3Bvs7Y5JGMw7s7XUWX6K',
    'QAstra Admin',
    'admin',
    TRUE,
    TRUE
